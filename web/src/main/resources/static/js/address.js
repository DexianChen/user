...
var Citys = [
    ["北京"],
    ["天津"],
    ["石家庄", "唐山", "秦皇岛", "张家口", "承德", "廊坊", "邯郸", "邢台", "保定", "沧州", "衡水"],
    ...
    ["海口","三亚","三沙","五指山","琼海","儋州","文昌","万宁","东方","定安县","屯昌县","澄迈县","临高县","白沙","昌江","乐东","陵水","保亭","琼中"],
    ...
    ["银川","石嘴山","吴忠","固原","中卫"],
    ["乌鲁木齐","克拉玛依","吐鲁番","哈密","昌吉","博尔塔拉","巴音郭楞","阿克苏","克孜勒苏","喀什","和田","伊犁","塔城","阿勒泰","石河子","阿拉尔","图木舒克","五家渠","北屯","铁门关","双河","可克达拉"],
    ["台湾"],
    ["澳门"],
    ["香港"]
];
...
var Areas = [
    ...
    [
        ["长安区","桥西区","新华区","井陉矿区","裕华区","井陉县","正定县","栾城区","行唐县","灵寿县","高邑县","深泽县","赞皇县","无极县","平山县","元氏县","赵县","辛集市","藁城区","晋州市","新乐市","鹿泉区"],
    ...
    [
        ["和平区","沈河区","大东区","皇姑区","铁西区","苏家屯区","浑南区","沈北新区","于洪区","辽中县","康平县","法库县","新民市"],
    ...
    [
        ["南关区","宽城区","朝阳区","二道区","绿园区","双阳区","农安县","九台区","榆树市","德惠市"],
    ...
    [
        ["道里区","南岗区","道外区","平房区","松北区","香坊区","呼兰区","阿城区","依兰县","方正县","宾县","巴彦县","木兰县","通河县","延寿县","双城区","尚志市","五常市"],
    ...
    [
        ...
        ["渝水区","分宜县"],
        ["月湖区","余江县","贵溪市"],
        ["章贡区","赣县","信丰县","大余县","上犹县","崇义县","安远县","龙南县","定南县","全南县","宁都县","于都县","兴国县","会昌县","寻乌县","石城县","瑞金市","南康区"],
    ...
    [
        ...
        ["滨城区","惠民县","阳信县","无棣县","沾化区","博兴县","邹平县"]
    ],

    [
        ["中原区","二七区","管城回族区","金水区","上街区","惠济区","中牟县","巩义市","荥阳市","新密市","新郑市","登封市"],
        ["龙亭区","顺河回族区","鼓楼区","禹王台区","杞县","通许县","尉氏县","祥符区","兰考县"],
    ...
    [
        ["万州区","涪陵区","渝中区","大渡口区","江北区","沙坪坝区","九龙坡区","南岸区","北碚区","綦江区","大足区","渝北区","巴南区","黔江区","长寿区","江津区","合川区","永川区","南川区","潼南县","铜梁区","荣昌县","璧山区","梁平县","城口县","丰都县","垫江县","武隆县","忠县","开县","云阳县","奉节县","巫山县","巫溪县","石柱土家族自治县","秀山土家族苗族自治县","酉阳土家族苗族自治县","彭水苗族土家族自治县"]
    ],
    ...
    [
        ["中西区","湾仔区","东区","南区","油尖旺区","深水埗区","九龍城区","黃大仙区","觀塘区","荃湾区","屯門区","元朗区","北区","大埔区","西贡区","沙田区","葵青区","離島区"]
    ],

    [
        ["花地玛堂区","花王堂区","望德堂区","大堂区","風順堂区","嘉模堂区","路氹城","圣方济各堂区"]
    ],
...
$(function () {
    for(var i=0;i<Provinces.length;i++){
        $('#selProvince').append('<option>'+Provinces[i]+'</option>');
    }
    ...
    $('#selCity').change(function () {
        $('#selArea').children().not(':eq(0)').remove();
        iNum2 = $("#selCity").children('option:selected').index();
